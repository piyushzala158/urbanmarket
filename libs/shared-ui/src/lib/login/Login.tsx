...
export const Login = ({admin,title}:loginPropsType) => {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  const onSubmit: SubmitHandler<loginDataType> = (data) => {
    // Signed in user with email and password
  ...
  return (
    <div className="">
      <div className="p-8 lg:w-1/2 mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 text-center py-4">
                  {title? title : 'Login'}
                </h1>
        {!admin ? (<div className="bg-white rounded-t-lg p-8">
        ...
        <div className="bg-gray-100 rounded-b-lg py-12 px-4 lg:px-24">
          {!admin ? (<p className="text-center text-sm text-gray-500 font-light">
          ...
          <form className="mt-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <p className=" text-red-500 ps-2 pt-1">{errors.email?.message}</p>
            ...
            <p className=" text-red-500 ps-2 pt-1">
            ...
            { !admin ? ( <p className=" text-center pt-4">
              If you are new then{' '}
